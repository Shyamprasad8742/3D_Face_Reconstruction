...
fixedPoints = detectMSERFeatures(FIXED,'ThresholdDelta',1.857778,'RegionAreaRange',[17 23372],'MaxAreaVariation',0.702500);
movingPoints = detectMSERFeatures(MOVING,'ThresholdDelta',1.857778,'RegionAreaRange',[17 23372],'MaxAreaVariation',0.702500);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',41.944444,'MaxRatio',0.419444);
